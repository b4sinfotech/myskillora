...
insert into public.categories (id, name, slug, description, type, parent_id, is_active, sort_order) values
  ...
  ('30000000-0000-0000-0000-000000000002', 'Orchestra',          'orchestra',       'Classical and modern orchestra instruments',                     'activity', '10000000-0000-0000-0000-000000000002', true, 2),
  ...
  ('30000000-0000-0000-0000-000000000009', 'Swimming',           'swimming',        'Swimming techniques, training, and water safety',                'activity', '10000000-0000-0000-0000-000000000002', true, 9),
  ('30000000-0000-0000-0000-000000000010', 'Public Speaking',    'public-speaking', 'Communication, debate, and presentation skills',                 'activity', '10000000-0000-0000-0000-000000000002', true, 10),
  ('30000000-0000-0000-0000-000000000011', 'Cooking & Baking',   'cooking',         'Culinary arts, baking, and nutrition basics',                    'activity', '10000000-0000-0000-0000-000000000002', true, 11),
  ('30000000-0000-0000-0000-000000000012', 'Photography',        'photography',     'Digital photography, editing, and composition',                  'activity', '10000000-0000-0000-0000-000000000002', true, 12)
on conflict (id) do nothing;
